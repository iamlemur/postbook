...
Should prevent highlight of search box caused by Bootstrap
Incorporate Sign Up links when not logged in and begin this workflow to expand CanCan authorization
Finish basic CRUD controller, models, and views for posts and authors